...
public class ApacheXTest extends AbstractIntegrationTest {

  @LocalServerPort
  private int port;

  @Autowired
  private ApacheX ApacheX;
  ...
  public void getReturnsExpectedGutHubStarText() throws Exception {
    ...
    assertThat(responseEntity.getBody().contains("Star ApacheX on GitHub"));
  }
