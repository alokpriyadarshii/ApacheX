...
echo ""
# Website used to generate the text: https://patorjk.com/software/taag/#p=display&f=Alligator2&t=APACHEX%204
echo ":::    :::     :::     :::::::::: :::::::::  :::::::::   ::::::::  :::::::::           :::    "
echo ":+:   :+:    :+: :+:   :+:        :+:    :+: :+:    :+: :+:    :+: :+:    :+:         :+:     "
echo "+:+  +:+    +:+   +:+  +:+        +:+    +:+ +:+    +:+ +:+    +:+ +:+    +:+        +:+ +:+  "
echo "+#++:++    +#++:++#++: :#::+::#   +#+    +:+ +#++:++#:  +#+    +:+ +#++:++#+        +#+  +:+  "
...
exec java $ARGS -Dloader.path=/extra-classes -jar /ApacheX*/ApacheX*jar ${CMD_ARGS}
